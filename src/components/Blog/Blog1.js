  ...
  return (
    <div className=" mb-10">
      <div className="w-fit  text-sm text-[#A6A6A6] cursor-pointer ">
        <Link href="/blog/allPost?filter=recent" className="flex items-center">
          {" "}
      ...
      <div className="w-full mt-8">
        <Image
          src={BlogImage1}
          className="w-full object-cover object-top h-[400px] sm:h-[500px] md:h-[620px]"
          alt=""
        />
        <div></div>
      </div>
          ...
          <div className="flex gap-3 items-center flex-1">
            {!love && (
              <>
                ...
                />{" "}
                <span className="text-lg text-[#818181] ">13</span>{" "}
              </>
            )}
            {love && (
              <>
                ...
                />{" "}
                <span className="text-lg text-[#818181] ">14</span>{" "}
              </>
            )}
          </div>
      ...
      <div className="mt-6">
        <div className="text-base md:text-lg ">
          In this blog, we would discuss what the{" "}
          <span className="font-semibold">SOLID</span> design principles are in
          the context of our chosen programming language{" "}
          ...
          <div className=" flex gap-4 ">
            ...
            <div>
              ...
              <div className="mt-2 text-base md:text-lg ">
                A class should only have a single responsibility meaning it
                should have only one functional reason to change.
              </div>
              ...
              <div className="mt-1">
                <div className="px-4">
                  ...
                  <div className="mt-1 flex gap-3 text-base md:text-lg">
                    ...
                    <span>
                      {" "}
                      however the class does more than 1 thing which is it
                ...
                <div className="mt-1">
                  <div className="px-4">
                    <div className="flex gap-3 text-base md:text-lg">
                      ...
                      <span>
                        {" "}
                        In the below example, ThreeDimension class extends the
                        TwoDimension class,
                      </span>
                    </div>
                    <div className="mt-1 flex gap-3 text-base md:text-lg">
                      ...
                      <span>
                        {" "}
                        however the derived class alters the behavior of the
                        base class by introducing one more parameter. It clearly
                        violates the rule of LISP.
                      </span>
                    </div>
                    <div className="mt-4">
                      <pre className=" break-words whitespace-pre-wrap">
            ...
            <div className=" flex gap-4 ">
              ...
              <div>
                ...
                <div className="mt-5 text-base md:text-lg ">
                  ...
                  meaning clients should not be forced to depend on interfaces
                  they do not use.{" "}
                  <Link
                    className="text-[#3A9ED9] underline  break-all"
                    target="_blank"
          ...
          <div className="mt-8 px-4">
            <div className=" flex gap-4 ">
              ...
              <div>
                ...
                <div className="mt-5 text-base md:text-lg ">
                  {`One should "depend upon abstractions, [not] concretions." This says high level modules should not depend on low level modules.  Both should depend upon abstractions (interfaces) and be implemented through dependency injection. `}
                  <Link
                    className="text-[#3A9ED9] underline  break-all"
                    target="_blank"
                    href="https://www.tutorialsteacher.com/ioc/dependency-inversion-principle"
                  >
            ...
            <div className="grid sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-10">
              ...
              >
                ...
                <div>
                  ...
                  <div className="mt-5 pb-20  text-xl md:text-2xl font-semibold text-gray-950 px-5">
                    Deciding on an efficient Locator strategy for multiple web
