          ...
          <div className="flex justify-center  lg:justify-between lg:items-center h-full lg:flex-row flex-col gap-y-4 top-[-5%] sm:top-[-10%] lg:top-0 relative">
            <div className="lg:order-1 order-2 " data-aos="fade-right">
              ...
              <div className="mt-4 sm:gap-x-3 flex sm:flex-row flex-col gap-y-3 justify-center items-center md:justify-start">
                <button
                  type="button"
                  className="text-white bg-[#3A9ED9] hover:bg-[#38789cfc] focus:outline-none  font-medium rounded-full text-sm md:text-xl px-7 md:px-10 lg:px-[27px] xl:px-10  py-[14px] lg:py-2.5 text-center me-2 mb-2 shadow-homeButtom"
            ...
            >
              <Image
                className="max-h-96 lg:max-h-[1000px] w-auto lg:w-[1250px] home-laptop-img"
                src={laptop}
                alt=""
              />
            </div>
