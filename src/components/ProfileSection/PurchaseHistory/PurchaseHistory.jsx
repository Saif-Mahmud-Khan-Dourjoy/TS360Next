    ...
    <>
      ...
      <div className="w-full mx-auto">
        <div className="min-w-full bg-white">
          {/* Header */}
          <div className="grid grid-cols-8 text-[#818181] text-sm">
            <div className="py-3 px-4 text-left font-bold">Order ID</div>
            <div className="py-3 px-4 text-left font-bold">Plan Name</div>
            <div className="py-3 px-4 text-left font-bold">Plan Type</div>
            <div className="py-3 px-4 text-left font-bold">Purchase Date</div>
            <div className="py-3 px-4 text-left font-bold">Quantity</div>
            <div className="py-3 px-4 text-left font-bold">Amount</div>
            <div className="py-3 px-4 text-left font-bold">Expiration Date</div>
            <div className="py-3 px-4 text-left font-bold"></div>
          </div>
          {/* Body */}
          {orders.map((order) => (
            <div key={order.id}>
              <div className="grid grid-cols-8 border-t items-center text-[#818181]">
                ...
                <div className="py-3 px-4">{order.purchaseDate}</div>
                <div className="py-3 px-4">{order.quantity}</div>
                <div className="py-3 px-4">{order.amount}</div>
                <div className="py-3 px-4">{order.expirationDate}</div>
